...
class Thing:
    ...
    def __init__(self,
        ...
        Args:
            thing_id (str, optional): The id of the Thing, starting with "dcd:things:". Looks for a THING_ID environment variable. Defaults to None.
            private_key_path (str, optional): Path to the private key to use for the generation of authentication tokens. The associated public key must be registered on Bucket. Defaults to "private.pem".

            name (str, optional): Name of a new Thing. Defaults to None.
            description (str, optional): Description of a new Thing. Defaults to None.
            thing_type (str, optional): Type of a new Thing. Defaults to None.
            properties (dict, optional): Properties of a new Thing. Defaults to ().

            json_thing (dict, optional): Provision thing details from a JSON object. Defaults to None.
        """
        self.properties = []
